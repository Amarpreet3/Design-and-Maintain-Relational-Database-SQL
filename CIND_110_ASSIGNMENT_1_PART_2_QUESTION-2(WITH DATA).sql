...
--
-- Host: 127.0.0.1    Database: registrardb
-- ------------------------------------------------------
...
CREATE TABLE `enroll` (
  ...
  KEY `FK_Student2_idx` (`St_Id`) /*!80000 INVISIBLE */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'registrardb'
--
...
-- Dump completed on 2022-10-14  0:43:22
